...
# Run `pod lib lint flutter_telegram_auth.podspec` to validate before publishing.
#
Pod::Spec.new do |s|
...
A Flutter plugin for integrating Telegram Login across Android, iOS, and Web. Uses native SDKs for mobile without webviews.
  ...
  # s.resource_bundles = {'flutter_telegram_auth_privacy' => ['Resources/PrivacyInfo.xcprivacy']}
end
